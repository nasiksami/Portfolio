...
function TimelineAccordion({ item, idx }) {
  ...
  return (
    <li className="flex items-start gap-6 pl-2 md:pl-8">
      {/* Company Logo */}
      {item.logo && (
        <img src={item.logo} alt={item.institution + ' logo'} className="w-12 h-12 md:w-16 md:h-16 rounded-full object-contain border-2 border-blue-200 bg-white shadow-md mr-4" style={{minWidth: 48}} />
      )}
  ...
  return (
    <div className="py-16 flex justify-center animate-fade-in">
      <div className="w-full max-w-3xl">
        <h2 className="text-3xl font-extrabold mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 dark:from-blue-600 dark:to-purple-600">Professional Experience</h2>
